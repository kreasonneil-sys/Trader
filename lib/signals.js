...
const ASSET_PROFILES = {
  ...
  satrix: {
    // Satrix 40 is an equity index ETF — moderate trends, mean-reverting dips
    rsiBounds: [35, 70],         // Slightly tighter than gold, equities revert faster
    txCost: 0.001,               // ETF trading costs
    breakoutLen: 15,             // Shorter breakout channel — equity rallies are quicker
    exitLen: 8,                  // Faster exit — equity corrections are sharp
    chandelierMult: 2.2,         // Tighter chandelier — equity vol is lower than gold
    ema1: 8,                     // Faster EMAs for quicker equity cycles
    ...
    cooldownBars: 2,             // Quick re-entry after bounces
    maxEquityDD: 12,
    tpMultiplier: 2.5,
    slMultiplier: 0.8,           // Tighter stop — equities have lower ATR
  },
  btc: {
    // Bitcoin — extreme volatility, strong momentum persistence, longer trends
    rsiBounds: [30, 80],         // BTC regularly trends at RSI 70-80 in bull markets
    txCost: 0.001,               // Exchange fees
    breakoutLen: 14,             // BTC breakouts are fast and violent — shorter channel
    exitLen: 7,                  // Very fast exit — BTC crashes are sudden
    chandelierMult: 3.5,         // Wide chandelier — BTC is extremely volatile
    ema1: 7,                     // Fast EMA for BTC's rapid cycles
    ema2: 21,                    // 21-day for medium trend
    ema3: 50,                    // 50-day for macro
    ...
    maxEquityDD: 20,             // BTC drawdowns can be deep, wider tolerance
    tpMultiplier: 4.0,           // 4:1 R:R — BTC trends run far
    slMultiplier: 1.2,           // Slightly wider stop for BTC volatility
  },
  default: {
    rsiBounds: [40, 60],
    txCost: 0.0015,
