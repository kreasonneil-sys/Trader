...
export async function fetchSignals(tickerCode = 'STX40.JO') {
  ...
  // RL Q-Learning
  const { Q, states, rlEquity, trades } = runQLearning(aligned, regimes, rsiAligned);
  ...
  const backtest = computeBacktestStats(rlEquity, bhEquity, trades, aligned);
