...
const ASSET_PROFILES = {
  ...
  satrix: {
    rsiBounds: [35, 70],
    txCost: 0.001,
    breakoutLen: 14, exitLen: 8, chandelierMult: 2.5,  // wider exit channel + chandelier = fewer false exits
    ema1: 8, ema2: 21, ema3: 50,
    pullbackReentry: true,
    pullbackZone: 0.02, pullbackRsiLo: 35, pullbackRsiHi: 65,
    macdAdxThresh: 22, cooldownBars: 2, maxEquityDD: 12,
    tpMultiplier: 2.5, slMultiplier: 0.8,
    breakoutRsiMin: 50,          // Require RSI momentum for breakout entries
    requireStrongTrend: true,    // Full EMA alignment required — filters false breakouts
  },
  btc: {
    rsiBounds: [30, 82],
    txCost: 0.001,
